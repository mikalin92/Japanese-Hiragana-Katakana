...
public class Katakana {
    ...
    public static final int SYMBOL_BLOCKSTART_HEXVALUE = 0x30A0;
    public static final String[] westernNames = {
        "sym0-a-A-i-I-u-U-e-E-o-O-Ka-ga-ki-gi-ku",
        ...
        "wi-we-wo-n-vu-ka-ke-va-vi-ve-vo-sym1-sym2-sym3-sym4-sym5"
    };
    public SymbolSystem sys;
    
    
    public Katakana() {
        this.sys=new SymbolSystem("Katakana",SYMBOL_BLOCKSTART_HEXVALUE,westernNames);
    }
